...
## 💭 Feedback
You can submit feedback through the [Carder Flashcards Feedback Form](https://forms.gle/E6yMc2RV1SNLDsEX9). If you ran into an issue/bug, please provide as much detail as possible in your feedback (e.g., the specific issue, steps to reproduce it, etc.). Any and all feedback will be used to improve future versions of the app
